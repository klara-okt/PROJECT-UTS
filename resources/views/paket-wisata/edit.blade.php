...
<div class="ep-wrap">
    <div class="ep-header">
        ...
        <div>
            <p class="ep-title">Edit Paket Wisata</p>
            <p class="ep-subtitle">Perbarui data paket perjalanan</p>
        </div>
    </div>

    <div class="ep-card">
        <div class="ep-badge">✎ Edit Data Paket Wisata</div>
            ...
            <div class="ep-grid">
                ...
                <div class="ep-field">
                    ...
                    <div class="ep-suffix">
                        <input type="number" id="durasi_jam" name="durasi_jam"
                            placeholder="0" min="1"
                            value="{{ old('durasi_jam', $paketWisata->durasi_jam) }}" required>
                ...
                <div class="ep-field">
                    ...
                    <div class="ep-suffix">
                        <input type="number" id="min_peserta" name="min_peserta"
                            placeholder="0" min="1"
                            value="{{ old('min_peserta', $paketWisata->min_peserta) }}" required>
                ...
                <div class="ep-field full">
                    ...
                    <div class="ep-toggle" onclick="toggleAktif()">
                        <div class="ep-toggle-track {{ $paketWisata->aktif ? 'on' : '' }}" id="toggleTrack">
                            <div class="ep-toggle-thumb"></div>
                        </div>
                        <span class="ep-toggle-label" id="toggleLabel">
                            {{ $paketWisata->aktif ? 'Ya — Paket aktif ditawarkan' : 'Tidak — Paket tidak aktif' }}
                        </span>
                        <input type="hidden" name="aktif" id="aktifVal" value="{{ $paketWisata->aktif ? '1' : '0' }}">
                    </div>
                </div>
