...
<div class="ep-wrap">
    <div class="ep-header">
        ...
        <div>
            <p class="ep-title">Edit Pemandu</p>
            <p class="ep-subtitle">Perbarui data pemandu wisata</p>
        </div>
    </div>

    <div class="ep-card">
        <div class="ep-badge">✎ Edit Data Pemandu</div>

        <form action="{{ route('pemandu.update', $pemandu->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="ep-grid">
                ...
                <div class="ep-field full">
                    ...
                    <input class="ep-input" type="text" id="nama" name="nama"
                        ...
                        value="{{ old('nama', $pemandu->nama) }}" required>
                </div>
                ...
                <div class="ep-field">
                    ...
                    <div class="ep-prefix">
                        ...
                        <input type="number" id="tarif_per_hari" name="tarif_per_hari"
                            placeholder="0" min="0"
                            value="{{ old('tarif_per_hari', $pemandu->tarif_per_hari) }}" required>
                    </div>
                </div>
                ...
                <div class="ep-field">
                    ...
                    <div class="ep-suffix">
                        <input type="number" id="pengalaman_tahun" name="pengalaman_tahun"
                            placeholder="0" min="0"
                            value="{{ old('pengalaman_tahun', $pemandu->pengalaman_tahun) }}" required>
                ...
                <div class="ep-field full">
                    ...
                    <div class="ep-tags-wrap" id="tagsWrap" onclick="document.getElementById('bahasaInput').focus()">
                        @foreach(explode(',', old('bahasa_dikuasai', $pemandu->bahasa_dikuasai)) as $bahasa)
                            @if(trim($bahasa))
                                <span class="ep-tag">{{ trim($bahasa) }} <button type="button" onclick="removeTag(this)">×</button></span>
                            @endif
                        @endforeach
                    ...
                    <input type="hidden" name="bahasa_dikuasai" id="bahasaHidden"
                        value="{{ old('bahasa_dikuasai', $pemandu->bahasa_dikuasai) }}">
                </div>
                ...
                <div class="ep-field full">
                    ...
                    <div class="ep-toggle" onclick="toggleAktif()">
                        <div class="ep-toggle-track {{ $pemandu->aktif ? 'on' : '' }}" id="toggleTrack">
                            <div class="ep-toggle-thumb"></div>
                        </div>
                        <span class="ep-toggle-label" id="toggleLabel">
                            {{ $pemandu->aktif ? 'Ya — Pemandu aktif bertugas' : 'Tidak — Pemandu tidak aktif' }}
                        </span>
                        <input type="hidden" name="aktif" id="aktifVal" value="{{ $pemandu->aktif ? '1' : '0' }}">
                    </div>
                </div>
