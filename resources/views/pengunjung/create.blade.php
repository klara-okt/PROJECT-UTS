...
<div class="ep-wrap">
    <div class="ep-header">
        ...
        <div>
            <p class="ep-title">Tambah Pengunjung</p>
            <p class="ep-subtitle">Catat data pengunjung baru</p>
        </div>
    </div>

    <div class="ep-card">
        <div class="ep-badge">+ Data Pengunjung</div>
